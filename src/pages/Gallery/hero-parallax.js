...
export const HeroParallax = ({ products }) => {
  ...
  return (
      ...
      <div
      ref={ref}
      className="h-[440vh] overscroll-none pt-40 overflow-vi bg-black  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
